            ...
            <div className={styles['intro']}>
                ...
                <div className={styles['container_intro']} >
                    <div className={styles['container_intro_titels']} >
                        <h2 className={styles['intro__subtitel']}> Open </h2>
                        <h2 className={styles['intro__subtitel__two']}> Universities. </h2>
                    ...
                    <div className={styles['container_intro_img']} >
                        ...
                        <input type='text' className={styles['search']} placeholder='🔍найдите что-то тут...' /> 
                    </div>
                </div>
